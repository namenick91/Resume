  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Разработал бенчмарк для выбора VLM, извлекающей табличные данные из разнотипных графиков (chart-to-table), с целью дальнейшего внедрения в сервис: 11 моделей, 5 датасетов, 8 метрик с bootstrap-CI.}
